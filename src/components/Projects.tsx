...
const Projects = () => {
  const projects = [
    ...
    {
      title: "Eryantis",
      description: "A strategic board game implementation",
      githubUrl: "https://github.com/camiandi/ingsw2022-AM35",
      image: "https://github.com/camiandi/ingsw2022-AM35/blob/master/src/main/resource/Graphics/Background/EriantysMenu.jpeg?raw=true",
      technologies: ["Java", "Game Development", "Strategy Games", "Maven"],
      hideYoutube: true,
      hideIeee: true,
